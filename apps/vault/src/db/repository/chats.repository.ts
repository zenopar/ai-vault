...
export async function updateChatRecord(
  ...
  return prisma.chats.update({
    ...
    data: {
      ...
      metadata_iv: data.metadata_iv,
      metadata_tag: data.metadata_tag,
      encrypted_input_tokens: data.encrypted_input_tokens,
      input_tokens_iv: data.input_tokens_iv,
      input_tokens_tag: data.input_tokens_tag,
      encrypted_output_tokens: data.encrypted_output_tokens,
      output_tokens_iv: data.output_tokens_iv,
      output_tokens_tag: data.output_tokens_tag,
      encrypted_input_cost: data.encrypted_input_cost,
      input_cost_iv: data.input_cost_iv,
      input_cost_tag: data.input_cost_tag,
      encrypted_output_cost: data.encrypted_output_cost,
      output_cost_iv: data.output_cost_iv,
      output_cost_tag: data.output_cost_tag,
      encrypted_total_cost: data.encrypted_total_cost,
      total_cost_iv: data.total_cost_iv,
      total_cost_tag: data.total_cost_tag,
      status: data.status,
      updated_at: new Date(),
    },
  });
